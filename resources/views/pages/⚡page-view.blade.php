...
new class extends Component {
    ...
    {
        if (in_array($this->staticPage->type, [PageType::LandingPage, PageType::IndexPage], true)) {
            return redirect()->to($this->staticPage->getURLValue());
        }

        views($this->staticPage)->record();
    }
};
?>
